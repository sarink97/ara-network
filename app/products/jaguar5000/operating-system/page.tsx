...
import { Cpu, Server, Gauge, ArrowRight, Layers, BarChart, Zap, Database, ChevronRight, Activity, Shield, CheckCircle2 } from "lucide-react";
...
const technologies = [
  {
    ...
    description: "JAGUAR5000's core scheduling technology combines thread systems with asynchronous scheduling.",
    benefits: [
  ...
  },
  {
    ...
    description: "Developed exclusively by ARA, WCOS is a proprietary file system engineered for maximum efficiency.",
    benefits: [
...
const highlights = [
  {
    ...
    description: "Optimized through ARA's cutting-edge O/S for unparalleled efficiency.",
    icon: Gauge,
    gradient: "from-blue-600 to-blue-400"
  },
  {
    title: "Proprietary Technologies",
    description: "Built on MCT and WCOS, enabling superior performance and reliability.",
    icon: Server,
    gradient: "from-indigo-600 to-blue-500"
  },
  {
    title: "Proven Excellence",
    description: "Field-tested and validated by numerous customers across various industries.",
    icon: BarChart,
          ...
          <div className="text-center">
            ...
            >
              ...
              <p className="text-lg text-blue-100 max-w-2xl mx-auto leading-relaxed mt-4">
                Experience the pinnacle of cache performance with our proprietary operating system
              </p>
            </motion.div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-6">
            {technologies.map((tech, index) => (
              ...
              >
                <div className={`w-12 h-12 rounded-lg bg-gradient-to-r ${tech.gradient} flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300`}>
