...
import { Cpu, Server, HardDrive, Network, Shield, BarChart, Zap, Database, Scale, Activity, Users, PlayCircle } from "lucide-react";
...
const features = [
  {
    ...
    description: "Powered by groundbreaking technology, delivering unmatched performance and continuous innovation. Hardware-independent software design ensures greater flexibility in storage configuration.",
    benefits: [
  ...
  },
  {
    ...
    description: "Supports tens of terabytes in a single system, expandable via external storage (NAS and DAS). Optimized for handling large content, such as video files.",
    benefits: [
  ...
  },
  {
    ...
    description: "Provides stable and reliable service for millions of simultaneous connections, even during high web traffic. Features built-in protection against cyber threats.",
    benefits: [
...
const highlights = [
  {
    ...
    description: "Increases performance proportionally with hardware upgrades, offering scalability for evolving needs.",
    icon: Scale,
    gradient: "from-blue-600 to-blue-400"
  },
  {
    title: "High Stability",
    description: "Designed to manage heavy traffic loads seamlessly while maintaining robust defenses against cyber threats.",
    icon: Shield,
    gradient: "from-indigo-600 to-blue-500"
  },
  {
    title: "Efficient Content Delivery",
    description: "Optimized for large-scale data delivery, making it ideal for video and bandwidth-intensive applications.",
    icon: PlayCircle,
          ...
          <div className="text-center">
            ...
            >
              ...
              <p className="text-lg text-blue-100 max-w-2xl mx-auto leading-relaxed mt-4">
                Experience unprecedented capacity and performance with our advanced caching solutions
              </p>
            </motion.div>
