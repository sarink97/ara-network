/*
  ...
  - Added the required column `region` to the `Partner` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `partner` ADD COLUMN `region` ENUM('NORTH_AMERICA', 'SOUTH_AMERICA', 'EUROPE', 'MIDDLE_EAST', 'AFRICA', 'ASIA_PACIFIC', 'CENTRAL_ASIA', 'CARIBBEAN') NOT NULL;
